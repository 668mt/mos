...
public class DirService extends BaseServiceImpl<Dir> {
    ...
    public Dir addDir0(String path, Long bucketId) {
        ...
        save(dir);
        auditService.doAudit(bucketId, new DirPathsEncryptContent(finalPath), Audit.Type.WRITE, Audit.Action.addDir);
        return dir;
    }
    ...
    public void updatePath(Long bucketId, DirUpdateDto dirUpdateDto) {
        ...
        auditService.doAudit(currentDir.getBucketId(), new DirPathsEncryptContent(currentDir.getPath()), Audit.Type.WRITE, Audit.Action.updateDir, currentDir.getPath() + "->" + newPath, 0);
    ...
    public void realDeleteDir(Long bucketId, long dirId) {
        ...
        auditService.doAudit(bucketId, new DirPathsEncryptContent(dir.getPath()), Audit.Type.WRITE, Audit.Action.deleteDir, null, 0);
        deleteById(dir);
    }
