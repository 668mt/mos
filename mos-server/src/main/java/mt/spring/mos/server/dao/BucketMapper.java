...
public interface BucketMapper extends BaseMapper<Bucket> {
	...
	@Select("select * from (select 1 as is_own\n" +
			...
			"\t\t\t,created_by\n" +
			"\t\t\t,updated_date\n" +
			"\t\t\t,updated_by,default_is_public,IFNULL(data_fragments_amount,1) AS data_fragments_amount \n" +
			...
			"\t\t\t,b.created_by\n" +
			"\t\t\t,b.updated_date\n" +
			"\t\t\t,b.updated_by,b.default_is_public,IFNULL(data_fragments_amount,1) AS data_fragments_amount \n" +
