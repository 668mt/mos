...
public class ResourceController {
    ...
    public ResResult list(
        ...
        auditService.doAudit(bucket.getId(), new DirPathsEncryptContent(resourceSearchDto.getPath() == null ? "/" : resourceSearchDto.getPath()), Audit.Type.READ, Audit.Action.list, null, 0);
