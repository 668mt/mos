...
public final class FreeMarkerUtils {
	@Autowired
	private static Map<String, TemplateModel> models = new HashMap<>();
	
	static {
		Map<String, TemplateModel> beansOfType = SpringUtils.getBeansOfType(TemplateModel.class);
		models = beansOfType;
	}
	 ...
	 * FreeMarker默认配置
	 */
	private static final freemarker.template.Configuration DEFAULT_CONFIGURATION = new Configuration(Configuration.VERSION_2_3_23);
